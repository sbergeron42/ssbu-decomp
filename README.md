...
| Verified byte-identical | 10,837 | 27.34% |
| Compiled (non-matching) | 4,845 | 12.22% |
| **Total decompiled** | **15,682** | **39.57%** |
| Undecompiled | 23,953 | 60.43% |

```
Verified  [##########                              ]  10,837 / 39,635  (27.34%)
Compiled  [###############                         ]  15,682 / 39,635  (39.57%)
```

> **10,837 functions verified byte-identical** against the real 13.0.4 binary.
