...
| Verified byte-identical | 7,689 | 19.40% |
| Compiled (non-matching) | 6,721 | 16.96% |
| **Total decompiled** | **14,410** | **36.36%** |
| Undecompiled | 25,225 | 63.64% |

```
Verified  [#######                                 ]  7,689 / 39,635  (19.40%)
Compiled  [##############                          ]  14,410 / 39,635  (36.36%)
```
