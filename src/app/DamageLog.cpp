...
void DamageLog__load_from_l2c_table_impl(DamageLog* obj, void* lv_in) {
    ...
    h = 0x35851bc47ULL;
    e = (*plv==5)?(int*)FUN_7103733d50(*(void**)(plv+2),&h):DAT_710593a3a8;
    { int t=*e; if(t==7||t==2) v=(float)*(long long*)(e+2); else if(t==3) v=*reinterpret_cast<float*>(e+2); else v=0.0f; *reinterpret_cast<float*>(reinterpret_cast<u8*>(obj)+0x44)=v; }
    // f32 at +0x48, hash 0xf70851bae
    h = 0xf70851baeULL;
    e = (*plv==5)?(int*)FUN_7103733d50(*(void**)(plv+2),&h):DAT_710593a3a8;
    { int t=*e; if(t==7||t==2) v=(float)*(long long*)(e+2); else if(t==3) v=*reinterpret_cast<float*>(e+2); else v=0.0f; *reinterpret_cast<float*>(reinterpret_cast<u8*>(obj)+0x48)=v; }
    // s32 at +0x4c, hash 0xedf149134
    h = 0xedf149134ULL;
    e = (*plv==5)?(int*)FUN_7103733d50(*(void**)(plv+2),&h):DAT_710593a3a8;
    { int t=*e; u32 r; if(t==7||t==2) r=(u32)*(long long*)(e+2); else if(t==3) r=(u32)(long long)*reinterpret_cast<float*>(e+2); else r=0; *reinterpret_cast<u32*>(reinterpret_cast<u8*>(obj)+0x4c)=r; }
    // u64 at +0x50, hash 0x5330809b6
    h = 0x5330809b6ULL;
    e = (*plv==5)?(int*)FUN_7103733d50(*(void**)(plv+2),&h):DAT_710593a3a8;
    { int t=*e; long long r; if(t==7||t==2) r=*(long long*)(e+2); else if(t==3) r=(long long)*reinterpret_cast<float*>(e+2); else r=0; *reinterpret_cast<long long*>(reinterpret_cast<u8*>(obj)+0x50)=r; }
    // f32 at +0x58, hash 0xb9ea8580a
    h = 0xb9ea8580aULL;
    e = (*plv==5)?(int*)FUN_7103733d50(*(void**)(plv+2),&h):DAT_710593a3a8;
    { int t=*e; if(t==7||t==2) v=(float)*(long long*)(e+2); else if(t==3) v=*reinterpret_cast<float*>(e+2); else v=0.0f; *reinterpret_cast<float*>(reinterpret_cast<u8*>(obj)+0x58)=v; }
    // s32 at +0x5c, hash 0x5a41a4ebb
    h = 0x5a41a4ebbULL;
    e = (*plv==5)?(int*)FUN_7103733d50(*(void**)(plv+2),&h):DAT_710593a3a8;
    { int t=*e; u32 r; if(t==7||t==2) r=(u32)*(long long*)(e+2); else if(t==3) r=(u32)(long long)*reinterpret_cast<float*>(e+2); else r=0; *reinterpret_cast<u32*>(reinterpret_cast<u8*>(obj)+0x5c)=r; }
    // f32 at +0x60, hash 0xbf6893440
    h = 0xbf6893440ULL;
    e = (*plv==5)?(int*)FUN_7103733d50(*(void**)(plv+2),&h):DAT_710593a3a8;
    { int t=*e; if(t==7||t==2) v=(float)*(long long*)(e+2); else if(t==3) v=*reinterpret_cast<float*>(e+2); else v=0.0f; *reinterpret_cast<float*>(reinterpret_cast<u8*>(obj)+0x60)=v; }
    // sub-table 0xe66eb42b7 → f32 x at +0x70, f32 y at +0x74
    h = 0xe66eb42b7ULL;
    sub = (*plv==5)?(int*)FUN_7103733d50(*(void**)(plv+2),&h):DAT_710593a3a8;
    h = 0x18cdc1683ULL;
    e = (*sub==5)?(int*)FUN_7103733d50(*(void**)(sub+2),&h):DAT_710593a3a8;
    { int t=*e; if(t==7||t==2) v=(float)*(long long*)(e+2); else if(t==3) v=*reinterpret_cast<float*>(e+2); else v=0.0f; *reinterpret_cast<float*>(reinterpret_cast<u8*>(obj)+0x70)=v; }
    h = 0xe66eb42b7ULL;
    sub = (*plv==5)?(int*)FUN_7103733d50(*(void**)(plv+2),&h):DAT_710593a3a8;
    h = 0x1fbdb2615ULL;
    e = (*sub==5)?(int*)FUN_7103733d50(*(void**)(sub+2),&h):DAT_710593a3a8;
    { int t=*e; if(t==7||t==2) v=(float)*(long long*)(e+2); else if(t==3) v=*reinterpret_cast<float*>(e+2); else v=0.0f; *reinterpret_cast<float*>(reinterpret_cast<u8*>(obj)+0x74)=v; }
    // s32 at +0x80, hash 0xa854977fe
    h = 0xa854977feULL;
    e = (*plv==5)?(int*)FUN_7103733d50(*(void**)(plv+2),&h):DAT_710593a3a8;
    { int t=*e; u32 r; if(t==7||t==2) r=(u32)*(long long*)(e+2); else if(t==3) r=(u32)(long long)*reinterpret_cast<float*>(e+2); else r=0; *reinterpret_cast<u32*>(reinterpret_cast<u8*>(obj)+0x80)=r; }
    // s32 at +0x84, hash 0x10d723eebb
    h = 0x10d723eebbULL;
    e = (*plv==5)?(int*)FUN_7103733d50(*(void**)(plv+2),&h):DAT_710593a3a8;
    { int t=*e; u32 r; if(t==7||t==2) r=(u32)*(long long*)(e+2); else if(t==3) r=(u32)(long long)*reinterpret_cast<float*>(e+2); else r=0; *reinterpret_cast<u32*>(reinterpret_cast<u8*>(obj)+0x84)=r; }
    // u8 at +0x88, hash 0x10860c2250
    h = 0x10860c2250ULL;
    e = (*plv==5)?(int*)FUN_7103733d50(*(void**)(plv+2),&h):DAT_710593a3a8;
    { int t=*e; u8 r; if(t==7||t==2) r=(u8)*(long long*)(e+2); else if(t==3) r=(u8)(long long)*reinterpret_cast<float*>(e+2); else r=0; reinterpret_cast<u8*>(obj)[0x88]=r; }
    ...
    h = 0x119f7207bbULL;
    e = (*plv==5)?(int*)FUN_7103733d50(*(void**)(plv+2),&h):DAT_710593a3a8;
    { int t=*e; u32 r; if(t==7||t==2) r=(u32)*(long long*)(e+2); else if(t==3) r=(u32)(long long)*reinterpret_cast<float*>(e+2); else r=0; *reinterpret_cast<u32*>(reinterpret_cast<u8*>(obj)+0x98)=r; }
    // u8 at +0x9c, hash 0x12d255714f
    h = 0x12d255714fULL;
    e = (*plv==5)?(int*)FUN_7103733d50(*(void**)(plv+2),&h):DAT_710593a3a8;
    { int t=*e; u8 r; if(t==7||t==2) r=(u8)*(long long*)(e+2); else if(t==3) r=(u8)(long long)*reinterpret_cast<float*>(e+2); else r=0; reinterpret_cast<u8*>(obj)[0x9c]=r; }
}
