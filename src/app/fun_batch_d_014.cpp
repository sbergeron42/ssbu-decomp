...
// Batch D - 014: init helpers, vtable wrappers, abort wrappers (0x71036-0x71037 range)
...
// 0x71036de518 -- vtable[0x38/8](), compare result to -1 (56 bytes)
u8 FUN_71036de518(s64 *param_1)
{
    s64 result = reinterpret_cast<s64 (*)()>(VT(param_1)[0x38 / 8])();
...
{
    reinterpret_cast<void (*)()>(VT(param_1)[1])();
...
// 0x71037c2690 -- vtable[1] (destructor), then memcpy via FUN_71037b2870 (64 bytes)
...
// 0x71037c2860 -- vtable[1] (destructor), then memcpy via FUN_71037b2870 (64 bytes)
...
// 0x71037c2a30 -- vtable[1] (destructor), then memcpy via FUN_71037b2870 (64 bytes)
