...
u64 FUN_7100228250(s64 *param_1, u64 param_2)
{
    ...
    puVar1 = (u64 *)FUN_7100228110(0x10);
    if (puVar1 == (u64 *)0x0) {
        return 0xfffffe0c;
    }
    *puVar1 = param_2;
    puVar1[1] = (u64)*param_1;
    *param_1 = (s64)puVar1;
    if (param_1[1] != 0) {
        return 0;
    }
...
void FUN_710022b140(s64 param_1, s64 param_2)
{
    ...
    *(u8 *)(param_2 + 8) = 0;
    if (*(s8 *)(param_1 + 0x69) == '\0') {
        ...
        if (*(s64 *)(lVar1 + 0x18) == *(s64 *)(param_1 + 0x18)) {
            *(s8 *)(param_1 + 8) = '\x01';
            *(u8 *)(param_2 + 8) = 0;
            cVar2 = *(s8 *)(param_1 + 8);
        } else {
            *(u8 *)(param_2 + 8) = *(u8 *)(*(s64 *)(lVar1 + 0x10) + *(s64 *)(lVar1 + 0x28) +
                                            *(s64 *)(param_1 + 0x18));
...
void FUN_710022b560(s64 param_1, u64 *param_2)
{
    ...
    lVar1 = FUN_71001d6b80(*(s64 *)(param_1 + 0x58) + 0x50);
    local_38 = param_2[0];
    local_30 = param_2[1];
    local_28 = param_2[2];
    FUN_71001b4300(lVar1 + 0x40, &local_38);
}
...
void FUN_7100231580(s64 param_1, u64 param_2, u64 param_3)
{
    ...
    *(u64 *)(param_1 + 0x20) = param_2;
    ...
    local_28 = param_2;
    FUN_71001df950(*(u64 *)(param_1 + 0x30), param_3, &local_28);
}
...
void FUN_7100240210(s64 param_1)
{
    ...
    local_28 = *(u64 *)(param_1 + 0x2a0);
    local_20 = *(u64 *)(param_1 + 0x2a8);
    local_18 = *(u64 *)(param_1 + 0x2b0);
    FUN_710023d9c0(param_1, &local_28);
}
...
u32 FUN_710026c5f0(s64 param_1, u64 param_2, u64 param_3, u8 param_4)
{
    ...
    local_14[0] = param_4 & 1;
    uVar1 = FUN_710026c2c0(param_1 + 8, param_2, param_3, local_14);
    return uVar1 & 1;
}
...
void FUN_71002b46c0(u64 *param_1, u64 *param_2)
{
    ...
    local_18 = param_2[1];
    local_20 = param_2[0];
    FUN_71002bbb30(*param_1, &local_20);
}
...
void FUN_71002b92c0(u32 *param_1)
{
    ...
    uVar3 = *param_1;
    uVar1 = -uVar3 & 0x3ff;
    if ((uVar3 & 0x3ff) == 0x1ff) {
        uVar1 = 0x200;
    }
    uVar2 = 0x1ff;
    if ((uVar3 & 0x3ff) != 0x200) {
        uVar2 = uVar1;
    }
    *param_1 = uVar3 & 0xfffffc00u | uVar2;
}
