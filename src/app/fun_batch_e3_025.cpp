...
// Pool-e worker: PostureModule 0x710206af80–0x710206b120, ReflectModule 0x710206ed10–0x710206ed80
// PostureModule module offset: +0x38, ReflectModule module offset: +0xf8

extern "C" u64 FUN_71038f4000(u64, int, int);

// ---- Module offset 0x38 (PostureModule) — rot_x/y/z component extractors ---

// 0x710206af80 (36 bytes) — float return (rot.x), vtable[0xd8]
// Calls rot() then extracts x-component: blr + ldr s0,[x0]
...
// Calls rot() then extracts y-component: blr + ldr s0,[x0,#4]
...
// Calls rot() then extracts z-component: blr + ldr s0,[x0,#8]
...
// ---- Module offset 0x38 (PostureModule) — continued -----------------------
...
// ---- Module offset 0xf8 (ReflectModule) ------------------------------------
