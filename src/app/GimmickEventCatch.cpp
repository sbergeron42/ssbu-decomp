...
LargeRet GimmickEventCatch__store_l2c_table_impl_71020e7940(GimmickEventCatch* ev, u64 p1) { return reinterpret_cast<LargeRet(*)(GimmickEventCatch*, u64)>(VT(ev)[0x30/8])(ev, p1); }
} // namespace app::lua_bind
