...
// ______ 0x710227db20 -- app::sv_system::owner_id (16B) _________________________________________________________________________________
...
// ______ 0x71022848d0 -- app::sv_ground_collision_line::is_floor (16B) _______________________________________
...
// ______ 0x710227ee10 -- app::sv_information::is_ready_go (32B) ____________________________________________________________
...
// ______ 0x7102283540 -- app::sv_battle_object::kind (144B) ________________________________________________________________________
u32 kind_7102283540(u32 id) {
    void* obj = resolve_battle_object(id);
    return *reinterpret_cast<u32*>(reinterpret_cast<u8*>(obj) + 0xc);
}

// ______ 0x71022839d0 -- app::sv_battle_object::is_active (144B) ______________________________________________________
bool is_active_71022839d0(u32 id) {
    void* obj = resolve_battle_object(id);
    return *reinterpret_cast<u8*>(reinterpret_cast<u8*>(obj) + 0x3a) > 3;
}

// ______ 0x7102283660 -- app::sv_battle_object::pos (160B) ________________________________________________________________________
...
// ______ 0x7102283920 -- app::sv_battle_object::set_float (176B) ______________________________________________________
...
// ______ 0x710227dfb0 -- app::sv_module_access::damage (192B) _______________________________________________________________
// accessor[+0x1a0] ___ accessor_data; uses module at +0xa8 (DamageModule)
...
// ______ 0x710227e070 -- app::sv_module_access::link (192B) _____________________________________________________________________
...
// ______ 0x710227e1f0 -- app::sv_module_access::search (192B) _______________________________________________________________
...
// ______ 0x7102276a40 -- app::sv_kinetic_energy::enable (192B) ____________________________________________________________
...
// ______ 0x7102276b00 -- app::sv_kinetic_energy::unable (192B) ____________________________________________________________
...
// ______ 0x7102276c90 -- app::sv_kinetic_energy::clear_speed (208B) _____________________________________________
...
// ______ 0x7102277640 -- app::sv_kinetic_energy::get_speed (256B) ___________________________________________________
...
// ______ 0x710227e930 -- app::FL_sv_module_access::link (320B) ____________________________________________________________
