...
LargeRet LinkEventCaptureMimikkyu__store_l2c_table_impl_71020b8990(LinkEventCaptureMimikkyu* ev, u64 p1) { return reinterpret_cast<LargeRet(*)(LinkEventCaptureMimikkyu*, u64)>(VT(ev)[0x30/8])(ev, p1); }
} // namespace app::lua_bind
