...
// MEDIUM-tier FUN_* functions â€” 0x7102 address range, batch e3-003
...
// 0x71020c6690 (192 bytes) â€” sound_module (acc+0x148), call playVoiceFurAsleep_71006eadc0(mod)
...
// 0x71023ed1e0 (112 bytes) â€” init DAT_7105307343 = 1
// Disasm: adrp+ldr(guard)â†’ ldarb; cbnz skip; bl __cxa_guard_acquire; cbz skip;
...
// 0x71023ed250 (112 bytes) â€” init DAT_7105307343 = 0
...
// 0x7102931ae0 (112 bytes) â€” vtable[0x30/8]() â†’ if result bit0 clear, store param_2 at +0x15d8
