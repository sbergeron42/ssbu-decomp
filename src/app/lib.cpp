...
extern "C" void* treeMapFindOrInsert_7103733d50(void*, void*);  // L2CValue tree get-or-insert by hash
...
void lib__Rect__load_from_l2c_table_impl(Rect* r, void* lv_in) {
    ...
    e = (*plv == 5) ? (int*)treeMapFindOrInsert_7103733d50(*(void**)(plv+2), &h0) : DAT_710593a3a8;
    ...
    e = (*plv == 5) ? (int*)treeMapFindOrInsert_7103733d50(*(void**)(plv+2), &h1) : DAT_710593a3a8;
    { int t=*e; if(t==7||t==2) v=(float)*(long long*)(e+2); else if(t==3) v=*reinterpret_cast<float*>(e+2); else v=0.0f; }
    r->y = v;
    // Rect::w at +8, hash 0x31ed91fca
    u64 h2 = 0x31ed91fcaULL;
    e = (*plv == 5) ? (int*)treeMapFindOrInsert_7103733d50(*(void**)(plv+2), &h2) : DAT_710593a3a8;
    { int t=*e; if(t==7||t==2) v=(float)*(long long*)(e+2); else if(t==3) v=*reinterpret_cast<float*>(e+2); else v=0.0f; }
    r->w = v;
    // Rect::h at +0xc, hash 0x6895f72a4
    u64 h3 = 0x6895f72a4ULL;
    e = (*plv == 5) ? (int*)treeMapFindOrInsert_7103733d50(*(void**)(plv+2), &h3) : DAT_710593a3a8;
    { int t=*e; if(t==7||t==2) v=(float)*(long long*)(e+2); else if(t==3) v=*reinterpret_cast<float*>(e+2); else v=0.0f; }
    r->h = v;
}
