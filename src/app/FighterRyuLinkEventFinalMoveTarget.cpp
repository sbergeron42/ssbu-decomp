...
void FighterRyuLinkEventFinalMoveTarget__store_l2c_table_impl(FighterRyuLinkEventFinalMoveTarget* ev) { reinterpret_cast<void(*)(FighterRyuLinkEventFinalMoveTarget*)>(VT(ev)[0x28/8])(ev); }
