...
LargeRet LinkEventLassoHang__store_l2c_table_impl_7102122390(LinkEventLassoHang* ev, u64 p1) { return reinterpret_cast<LargeRet(*)(LinkEventLassoHang*, u64)>(VT(ev)[0x30/8])(ev, p1); }
} // namespace app::lua_bind
