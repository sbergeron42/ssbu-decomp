...
// -- FUN_7100018910 ----------------------------------------------------------
// 7100018910
u64 FUN_7100018910(u64 param_1, s32 *param_2, s32 param_3)
{
    typedef u64 (*fn_t)(u64, s32 *, s32);
    fn_t fn = (fn_t)(*(u64 *)(*(u64 *)(param_1 + 0x858) + 0x58));
    if (fn) return fn(param_1, param_2, param_3);
    if (param_3 < 2) return 0;
    u64 lVar4 = *(u64 *)param_1;
    u32 uVar2 = *(u32 *)(lVar4 + 0x224);
    bool bVar1 = (uVar2 & 0x15) == 1;
    if (bVar1) {
        *param_2 = *(s32 *)(param_1 + 0x870);
        uVar2 = *(u32 *)(lVar4 + 0x224);
    }
    if ((uVar2 & 0x2a) != 2) return (u64)bVar1;
    u32 uVar3 = (u32)bVar1;
    if (uVar3 != 0 && *(s32 *)(param_1 + 0x870) == *(s32 *)(param_1 + 0x874)) {
        return (u64)(uVar3 | 0x10000u);
    }
    param_2[bVar1] = *(s32 *)(param_1 + 0x874);
    return (u64)(1u << (u32)(uVar3 | 0x10) | uVar3);
}
...
// -- FUN_7100060ee0 ----------------------------------------------------------
// 7100060ee0
void FUN_7100060ee0(u8 *param_1, u64 param_2)
{
    if (param_2 != 0) {
...
// -- FUN_71000650c0 ----------------------------------------------------------
// 71000650c0
u64 FUN_71000650c0(u64 param_1, u64 param_2)
{
    u64 lVar1 = *(u64 *)(param_1 + 8);
    do {
        if (param_1 == lVar1) return 0;
        u64 uVar2 = 0;
        while (*(char *)(param_2 + uVar2) == *(char *)(lVar1 + 0x10 + uVar2)) {
            if (*(char *)(param_2 + uVar2) == '\0' || (uVar2 = uVar2 + 1, uVar2 > 0x7f)) {
                return *(u64 *)(lVar1 + 0x90);
            }
        }
        lVar1 = *(u64 *)(lVar1 + 8);
...
// -- FUN_7100078f60 ----------------------------------------------------------
// 7100078f60
void FUN_7100078f60(u64 param_1)
{
    *(u32 *)(*(u64 *)(param_1 + 0x30) + 0x9c) = 0;
}
...
u32 FUN_7100078fd0(u64 param_1, u64 param_2, u64 *param_3)
{
    ...
    u64 lVar1 = param_3[0];
    if (lVar1 == 0) return 0;
    *(s32 *)(param_1 + 0x98) = count;
    *(u32 *)(param_1 + 0x9c) = 0;
    *(u64 *)(param_1 + 0xa0) = lVar1;
    *(u64 *)(param_1 + 0xa8) = lVar1 + (u64)(s64)count * 0x38;
    *(u8  *)(param_1 + 0xb8) = *(u8 *)((u64)param_3 + 0x14);
    *(u8  *)(param_1 + 0xb9) = *(u8 *)((u64)param_3 + 0x15);
    *(u8  *)(param_1 + 0xba) = *(u8 *)((u64)param_3 + 0x16);
    *(u8  *)(param_1 + 0xbb) = *(u8 *)((u64)param_3 + 0x17);
    *(u64 *)(param_1 + 0xb0) = param_3[1];
    return 1;
}
...
// -- FUN_710008a740 ----------------------------------------------------------
// 710008a740
void FUN_710008a740(u64 param_1)
{
...
// -- FUN_71000b3840 ----------------------------------------------------------
// 71000b3840
void FUN_71000b3840(u64 param_1, u64 param_2)
{
...
// -- FUN_71000b3850 ----------------------------------------------------------
// 71000b3850
void FUN_71000b3850(u64 param_1)
{
    *(u64 *)(param_1 + 0x598) = 0;
}
...
// -- FUN_71000b4150 ----------------------------------------------------------
// 71000b4150
void FUN_71000b4150(u64 param_1, u64 param_2, u64 param_3)
{
...
// -- FUN_71000b63c0 ----------------------------------------------------------
// 71000b63c0
void FUN_71000b63c0(u64 param_1, u64 param_2)
{
    memset_s((void *)param_1, param_2, 0, param_2);
}
...
// -- FUN_71000bae50 ----------------------------------------------------------
// 71000bae50
u32 FUN_71000bae50(u64 param_1)
{
...
// -- FUN_71000bae60 ----------------------------------------------------------
// 71000bae60
u64 FUN_71000bae60(u64 param_1)
{
...
// -- FUN_71000beb20 ----------------------------------------------------------
// 71000beb20
void FUN_71000beb20(u64 param_1)
{
...
// -- FUN_71000beb30 ----------------------------------------------------------
// 71000beb30
void FUN_71000beb30(u64 param_1, u64 param_2)
{
...
// -- FUN_71000bedc0 ----------------------------------------------------------
// 71000bedc0
void FUN_71000bedc0(u64 param_1)
{
    *(u8 *)(param_1 + 8) = 0;
}
...
// -- FUN_71000c4cc0 ----------------------------------------------------------
// 71000c4cc0
void FUN_71000c4cc0(u64 param_1, u32 param_2)
{
...
// -- FUN_71000c5330 ----------------------------------------------------------
// 71000c5330
u64 FUN_71000c5330(u64 param_1)
{
    u64 x0 = *(u64 *)(param_1 + 0x90);
    if (x0 == 0) return 0;
    return FUN_71000c7460(x0);
}
...
// -- FUN_71000c74a0 ----------------------------------------------------------
// 71000c74a0
u64 FUN_71000c74a0(u64 param_1)
{
...
// -- FUN_71000c74b0 ----------------------------------------------------------
// 71000c74b0
u16 FUN_71000c74b0(u64 param_1)
{
...
// -- FUN_71000c74d0 ----------------------------------------------------------
// 71000c74d0
u64 FUN_71000c74d0(u64 param_1)
{
...
// -- FUN_71000c87e0 ----------------------------------------------------------
// 71000c87e0
u32 FUN_71000c87e0(u64 param_1)
{
...
// -- FUN_71000cb3b0 ----------------------------------------------------------
// 71000cb3b0
u64 FUN_71000cb3b0(u64 param_1)
{
...
// -- FUN_71000cb3c0 ----------------------------------------------------------
// 71000cb3c0
u64 FUN_71000cb3c0(u64 param_1)
{
...
// -- FUN_71000d3390 ----------------------------------------------------------
// 71000d3390
void FUN_71000d3390(u64 param_1, u64 param_2)
{
