...
LargeRet GimmickEventTornadoShootInfo__store_l2c_table_impl_71020e3580(GimmickEventTornadoShootInfo* ev, u64 p1) { return reinterpret_cast<LargeRet(*)(GimmickEventTornadoShootInfo*, u64)>(VT(ev)[0x30/8])(ev, p1); }
} // namespace app::lua_bind
