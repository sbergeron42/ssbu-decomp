...
void GimmickEventTornadoShootInfo__store_l2c_table_impl(GimmickEventTornadoShootInfo* ev) { reinterpret_cast<void(*)(GimmickEventTornadoShootInfo*)>(VT(ev)[0x28/8])(ev); }
