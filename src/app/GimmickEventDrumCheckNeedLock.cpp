...
LargeRet GimmickEventDrumCheckNeedLock__store_l2c_table_impl_71020e9460(GimmickEventDrumCheckNeedLock* ev, u64 p1) { return reinterpret_cast<LargeRet(*)(GimmickEventDrumCheckNeedLock*, u64)>(VT(ev)[0x30/8])(ev, p1); }
} // namespace app::lua_bind
