...
LargeRet GimmickEventPos__store_l2c_table_impl_71020d5870(GimmickEventPos* ev, u64 p1) { return reinterpret_cast<LargeRet(*)(GimmickEventPos*, u64)>(VT(ev)[0x30/8])(ev, p1); }
} // namespace app::lua_bind
