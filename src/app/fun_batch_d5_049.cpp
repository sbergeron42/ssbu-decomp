...
// Pool-e worker: optnone for -O0 stubs
// 0x71037* and 0x71038* misc functions
...
extern __attribute__((visibility("hidden"))) u8 *PTR_VirtualFreeHook_71052a7a70;
...
// ===========================================================================
// Group 1: Optnone leaf functions (sub sp, no calls)
// ===========================================================================

// 0x71037bc140 — return pointer offset (24 bytes)
...
// ===========================================================================
// Group 2: Optnone functions with calls (sub sp + stp x29,x30 inside)
// ===========================================================================

// 0x71037aee70 — negate and wrap a 2D angle vector (80 bytes)
__attribute__((optnone))
...
// 0x71037b0ae0 — rotate 2D vector 90 degrees (80 bytes)
__attribute__((optnone))
...
// 0x71037b0c30 — copy two sub-objects and the trailing field (68 bytes)
__attribute__((optnone))
...
// 0x71037b0ce0 — wrapper (36 bytes)
__attribute__((optnone))
void FUN_71037b0ce0(u64 param_1) {
    FUN_71037b0cd0(param_1);
}

// 0x71037b12a0 — wrapper (36 bytes)
__attribute__((optnone))
void FUN_71037b12a0(u64 param_1) {
    FUN_71037b0cd0(param_1);
}

// 0x71037b1250 — copy sub-objects + 0x8c bytes (76 bytes)
__attribute__((optnone))
...
// 0x71037b1d20 — sin/cos decompose (68 bytes)
__attribute__((optnone))
...
// 0x71037b3820 — three-step op with counter decrement (80 bytes)
__attribute__((optnone))
...
// 0x71037b4a90 — two-call wrapper (68 bytes)
__attribute__((optnone))
...
// 0x71037bcc00 — wrapper (36 bytes)
__attribute__((optnone))
void FUN_71037bcc00(u64 param_1) {
    FUN_71037bc730(param_1);
}

// 0x71037bd490 — wrapper (36 bytes)
__attribute__((optnone))
void FUN_71037bd490(u64 param_1) {
    FUN_71037bc730(param_1);
}

// 0x71037bf8c0 — wrapper (36 bytes)
__attribute__((optnone))
void FUN_71037bf8c0(u64 param_1) {
    FUN_71037bc730(param_1);
}

// 0x71037c1600 — compose two calls (72 bytes)
__attribute__((optnone))
...
// 0x71037c2460 — wrapper (36 bytes)
__attribute__((optnone))
void FUN_71037c2460(u64 param_1) {
    FUN_71037bc730(param_1);
}

// 0x71037c2630 — wrapper (36 bytes)
__attribute__((optnone))
void FUN_71037c2630(u64 param_1) {
    FUN_71037bc730(param_1);
}

// 0x71037c2800 — wrapper (36 bytes)
__attribute__((optnone))
void FUN_71037c2800(u64 param_1) {
    FUN_71037bc730(param_1);
}

// 0x71037c29d0 — wrapper (36 bytes)
__attribute__((optnone))
...
// ===========================================================================
// Group 3: -O2 functions (stp x29,x30 first instruction)
// ===========================================================================

// 0x71038647b0 — write "nn::GP_NULL\x0b" string literal (44 bytes)
...
// 0x7103815c70 — wrapper returning 1 (28 bytes)
u64 FUN_7103815c70(s64 param_1) {
    FUN_71037f0c00(*(u64 *)(param_1 + 0x18));
    return 1;
}

// 0x7103869bc0 — recursive binary-tree free (left, right, then node) (76 bytes)
...
// 0x710386ddd0 — recursive binary-tree free (same pattern, different tree) (76 bytes)
...
// 0x71038717a0 — recursive binary-tree free (same pattern, different tree) (76 bytes)
...
// 0x7103871190 — switch: return 0 for most, param_2 for case 3 (56 bytes)
...
// 0x71038e0600 — switch: case 0 or 1 return param_2, else abort (60 bytes)
...
// 0x71038e0650 — switch: case 1 returns param_2, case 0 returns 0 (60 bytes)
