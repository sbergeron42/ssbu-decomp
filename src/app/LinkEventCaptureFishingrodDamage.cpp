...
void LinkEventCaptureFishingrodDamage__store_l2c_table_impl(LinkEventCaptureFishingrodDamage* ev) { reinterpret_cast<void(*)(LinkEventCaptureFishingrodDamage*)>(VT(ev)[0x28/8])(ev); }
