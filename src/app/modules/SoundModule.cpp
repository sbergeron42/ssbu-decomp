...
#define SOUND_MODULE(acc) (acc->sound_module)
...
void* SoundModule__play_hit_se_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2) { auto* m=a->sound_module; return reinterpret_cast<void*(*)(void*,u64,u64)>(VTABLE(m)[0xf8/8])(m,p1,p2); }

// 7102081a60 -- play_damage_se [vtable+0x100]
void* SoundModule__play_damage_se_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2,u64 p3,u64 p4) { auto* m=a->sound_module; return reinterpret_cast<void*(*)(void*,u64,u64,u64,u64)>(VTABLE(m)[0x100/8])(m,p1,p2,p3,p4); }
...
void* SoundModule__play_fly_voice_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2) { auto* m=a->sound_module; return reinterpret_cast<void*(*)(void*,u64,u64)>(VTABLE(m)[0x130/8])(m,p1,p2); }

// 7102081ad0 -- get_se_vol [vtable+0x140]
void* SoundModule__get_se_vol_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=a->sound_module; return reinterpret_cast<void*(*)(void*,u64)>(VTABLE(m)[0x140/8])(m,p1); }

// 7102081af0 -- get_se_vol_db [vtable+0x150]
void* SoundModule__get_se_vol_db_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=a->sound_module; return reinterpret_cast<void*(*)(void*,u64)>(VTABLE(m)[0x150/8])(m,p1); }
...
bool SoundModule__is_playing_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=a->sound_module; return reinterpret_cast<bool(*)(void*,u64)>(VTABLE(m)[0x260/8])(m,p1); }

// 7102081cc0 -- is_playing_status [vtable+0x268]
bool SoundModule__is_playing_status_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=a->sound_module; return reinterpret_cast<bool(*)(void*,u64)>(VTABLE(m)[0x268/8])(m,p1); }
...
void* SoundModule__get_common_sound_label_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=a->sound_module; return reinterpret_cast<void*(*)(void*,u64)>(VTABLE(m)[0x278/8])(m,p1); }
...
void* SoundModule__play_step_flippable_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2) { auto* m=a->sound_module; return reinterpret_cast<void*(*)(void*,u64,u64)>(VTABLE(m)[0x110/8])(m,p1,p2); }
void SoundModule__set_se_vol_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2) { auto* m=a->sound_module; reinterpret_cast<void(*)(void*,u64,u64)>(VTABLE(m)[0x138/8])(m,p1,p2); }
void SoundModule__set_se_vol_db_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2) { auto* m=a->sound_module; reinterpret_cast<void(*)(void*,u64,u64)>(VTABLE(m)[0x148/8])(m,p1,p2); }
void SoundModule__set_auto_se_pitch_impl(BattleObjectModuleAccessor* a) { auto* m=a->sound_module; reinterpret_cast<void(*)(void*)>(VTABLE(m)[0x158/8])(m); }
...
void SoundModule__set_se_pitch_status_impl(BattleObjectModuleAccessor* a) { auto* m=a->sound_module; reinterpret_cast<void(*)(void*)>(VTABLE(m)[0x178/8])(m); }
...
void SoundModule__stop_se_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2) { auto* m=a->sound_module; reinterpret_cast<void(*)(void*,u64,u64)>(VTABLE(m)[0x190/8])(m,p1,p2); }
...
void SoundModule__stop_loop_se_all_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=a->sound_module; reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0x1a0/8])(m,p1); }
void SoundModule__stop_se_handle_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2) { auto* m=a->sound_module; reinterpret_cast<void(*)(void*,u64,u64)>(VTABLE(m)[0x1a8/8])(m,p1,p2); }
...
void SoundModule__set_play_inhivit_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2) { auto* m=a->sound_module; reinterpret_cast<void(*)(void*,u64,u64)>(VTABLE(m)[0x258/8])(m,p1,p2); }
