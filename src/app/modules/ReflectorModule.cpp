...
bool ReflectorModule__is_shield_impl(BattleObjectModuleAccessor* a) { auto* m=RF(a); return reinterpret_cast<bool(*)(void*)>(VT(m)[0x88/8])(m); }
bool ReflectorModule__is_turn_impl(BattleObjectModuleAccessor* a) { auto* m=RF(a); return reinterpret_cast<bool(*)(void*)>(VT(m)[0xA8/8])(m); }
bool ReflectorModule__is_front_impl(BattleObjectModuleAccessor* a) { auto* m=RF(a); return reinterpret_cast<bool(*)(void*)>(VT(m)[0xB0/8])(m); }
bool ReflectorModule__is_hop_impl(BattleObjectModuleAccessor* a) { auto* m=RF(a); return reinterpret_cast<bool(*)(void*)>(VT(m)[0xB8/8])(m); }
f32 ReflectorModule__get_hop_angle_impl(BattleObjectModuleAccessor* a) { auto* m=RF(a); return reinterpret_cast<f32(*)(void*)>(VT(m)[0xC0/8])(m); }
bool ReflectorModule__is_no_hop_impl(BattleObjectModuleAccessor* a) { auto* m=RF(a); return reinterpret_cast<bool(*)(void*)>(VT(m)[0xC8/8])(m); }
f32 ReflectorModule__get_attack_mul_impl(BattleObjectModuleAccessor* a) { auto* m=RF(a); return reinterpret_cast<f32(*)(void*)>(VT(m)[0xF0/8])(m); }
f32 ReflectorModule__get_speed_mul_impl(BattleObjectModuleAccessor* a) { auto* m=RF(a); return reinterpret_cast<f32(*)(void*)>(VT(m)[0x100/8])(m); }
f32 ReflectorModule__get_life_mul_impl(BattleObjectModuleAccessor* a) { auto* m=RF(a); return reinterpret_cast<f32(*)(void*)>(VT(m)[0x110/8])(m); }
f32 ReflectorModule__get_attack_limit_impl(BattleObjectModuleAccessor* a) { auto* m=RF(a); return reinterpret_cast<f32(*)(void*)>(VT(m)[0x120/8])(m); }
bool ReflectorModule__is_no_m_ball_impl(BattleObjectModuleAccessor* a) { auto* m=RF(a); return reinterpret_cast<bool(*)(void*)>(VT(m)[0x140/8])(m); }
u32 ReflectorModule__get_part_size_impl(BattleObjectModuleAccessor* a) { auto* m=RF(a); return reinterpret_cast<u32(*)(void*)>(VT(m)[0x148/8])(m); }
...
void ReflectorModule__clear_all_2_impl(BattleObjectModuleAccessor* a) { auto* m=RF(a); reinterpret_cast<void(*)(void*)>(VT(m)[0x190/8])(m); }
void* ReflectorModule__get_center_pos_impl(BattleObjectModuleAccessor* a) { auto* m=RF(a); return reinterpret_cast<void*(*)(void*)>(VT(m)[0x198/8])(m); }
