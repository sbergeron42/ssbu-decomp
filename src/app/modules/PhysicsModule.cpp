...
u32 PhysicsModule__get_2nd_node_num_impl(BattleObjectModuleAccessor* a) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x80)); return reinterpret_cast<u32(*)(void*)>(VT(m)[0x150/8])(m); }
u32 PhysicsModule__get_2nd_active_node_num_impl(BattleObjectModuleAccessor* a) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x80)); return reinterpret_cast<u32(*)(void*)>(VT(m)[0x158/8])(m); }
void* PhysicsModule__get_2nd_active_length_impl(BattleObjectModuleAccessor* a) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x80)); return reinterpret_cast<void*(*)(void*)>(VT(m)[0x160/8])(m); }
u32 PhysicsModule__get_2nd_joint_num_impl(BattleObjectModuleAccessor* a) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x80)); return reinterpret_cast<u32(*)(void*)>(VT(m)[0x248/8])(m); }
...
void PhysicsModule__clear_2nd_speed_impl(BattleObjectModuleAccessor* a) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x80)); reinterpret_cast<void(*)(void*)>(VT(m)[0x2e8/8])(m); }
