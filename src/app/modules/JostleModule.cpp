...
void* JostleModule__ignore_owner_id_impl(BattleObjectModuleAccessor* a) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x118)); return reinterpret_cast<void*(*)(void*)>(VT(m)[0xf0/8])(m); }
...
void JostleModule__set_push_speed_x_2_impl(BattleObjectModuleAccessor* a,u64 p1,bool p2) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x118)); reinterpret_cast<void(*)(void*,u64,bool)>(VT(m)[0xc0/8])(m,p1,p2); }
...
void JostleModule__set_push_speed_x_overlap_rate_impl(BattleObjectModuleAccessor* a) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x118)); reinterpret_cast<void(*)(void*)>(VT(m)[0x110/8])(m); }
void JostleModule__set_push_speed_x_overlap_rate_status_impl(BattleObjectModuleAccessor* a) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x118)); reinterpret_cast<void(*)(void*)>(VT(m)[0x118/8])(m); }
f32 JostleModule__weight_impl(BattleObjectModuleAccessor* a) { auto* m=JM(a); return reinterpret_cast<f32(*)(void*)>(VT(m)[0x128/8])(m); }
void JostleModule__set_weight_impl(BattleObjectModuleAccessor* a) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x118)); reinterpret_cast<void(*)(void*)>(VT(m)[0x130/8])(m); }
