...
void CaptureModule__capture_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2,bool p3) { auto* m=CP(a); reinterpret_cast<void(*)(void*,u64,u64,bool)>(VT(m)[0x78/8])(m,p1,p2,p3); }
void CaptureModule__capture_2_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2,u64 p3,bool p4) { auto* m=CP(a); reinterpret_cast<void(*)(void*,u64,u64,u64,bool)>(VT(m)[0x80/8])(m,p1,p2,p3,p4); }
...
void CaptureModule__check_damage_impl(BattleObjectModuleAccessor* a) { auto* m=CP(a); reinterpret_cast<void(*)(void*)>(VT(m)[0xa8/8])(m); }
...
u32 CaptureModule__motion_impl(BattleObjectModuleAccessor* a) { auto* m=CP(a); return reinterpret_cast<u32(*)(void*)>(VT(m)[0x118/8])(m); }
u32 CaptureModule__motion_lw_impl(BattleObjectModuleAccessor* a) { auto* m=CP(a); return reinterpret_cast<u32(*)(void*)>(VT(m)[0x120/8])(m); }
u32 CaptureModule__motion_offset_lw_2_impl(BattleObjectModuleAccessor* a) { auto* m=CP(a); return reinterpret_cast<u32(*)(void*)>(VT(m)[0x128/8])(m); }
