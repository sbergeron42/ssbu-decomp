...
void* CaptureModule__capture_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2,bool p3,u64 p4) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x138)); return reinterpret_cast<void*(*)(void*,u64,u64,bool,u64)>(VT(m)[0x78/8])(m,p1,p2,p3,p4); }
void* CaptureModule__capture_2_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2,u64 p3,bool p4,u64 p5) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x138)); return reinterpret_cast<void*(*)(void*,u64,u64,u64,bool,u64)>(VT(m)[0x80/8])(m,p1,p2,p3,p4,p5); }
...
void* CaptureModule__check_damage_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x138)); return reinterpret_cast<void*(*)(void*,u64)>(VT(m)[0xa8/8])(m,p1); }
...
void* CaptureModule__motion_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x138)); return reinterpret_cast<void*(*)(void*,u64,u64)>(VT(m)[0x118/8])(m,p1,p2); }
void* CaptureModule__motion_lw_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x138)); return reinterpret_cast<void*(*)(void*,u64,u64)>(VT(m)[0x120/8])(m,p1,p2); }
void* CaptureModule__motion_offset_lw_2_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x138)); return reinterpret_cast<void*(*)(void*,u64)>(VT(m)[0x128/8])(m,p1); }
...
void CaptureModule__set_nodes_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x138)); reinterpret_cast<void(*)(void*,u64,u64)>(VT(m)[0x48/8])(m,p1,p2); }
...
void* CaptureModule__thrown_impl(BattleObjectModuleAccessor* a) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x138)); return reinterpret_cast<void*(*)(void*)>(VT(m)[0xb8/8])(m); }
