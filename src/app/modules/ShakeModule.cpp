...
void ShakeModule__req_time_scale_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2,bool p3,u64 p4,bool p5,bool p6) { auto* m=SK(a); reinterpret_cast<void(*)(void*,u64,u64,bool,u64,bool,bool)>(VT(m)[0x58/8])(m,p1,p2,p3,p4,p5,p6); }
