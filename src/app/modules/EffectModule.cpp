...
void EffectModule__req_2d_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2,u64 p3,u64 p4,u64 p6) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x140)); reinterpret_cast<void(*)(void*,u64,u64,u64,u64,u64,u64,u64)>(VTABLE(m)[0x68/8])(m,p1,p2,p3,p4,p6,static_cast<u64>(-1),0); }
} // namespace app::lua_bind
