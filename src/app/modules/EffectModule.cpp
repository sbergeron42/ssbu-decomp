...
void EffectModule__req_impl(BattleObjectModuleAccessor* a,u64 p1,bool p2) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64,bool)>(VTABLE(m)[0x68/8])(m,p1,p2); }
void EffectModule__req_attach_ground_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0x78/8])(m,p1); }
void EffectModule__req_continual_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0x88/8])(m,p1); }
...
void EffectModule__req_time_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2,bool p3) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64,u64,bool)>(VTABLE(m)[0xa0/8])(m,p1,p2,p3); }
void EffectModule__req_time_follow_impl(BattleObjectModuleAccessor* a,u64 p1,bool p2) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64,bool)>(VTABLE(m)[0xa8/8])(m,p1,p2); }
...
void EffectModule__req_emit_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0xc0/8])(m,p1); }
void EffectModule__remove_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0xc8/8])(m,p1); }
void EffectModule__remove_all_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0xd0/8])(m,p1); }
void EffectModule__kill_impl(BattleObjectModuleAccessor* a,u64 p1,bool p2) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64,bool)>(VTABLE(m)[0xd8/8])(m,p1,p2); }
void EffectModule__kill_kind_impl(BattleObjectModuleAccessor* a,u64 p1,bool p2) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64,bool)>(VTABLE(m)[0xe0/8])(m,p1,p2); }
void EffectModule__kill_joint_id_impl(BattleObjectModuleAccessor* a,u64 p1,bool p2) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64,bool)>(VTABLE(m)[0xe8/8])(m,p1,p2); }
void EffectModule__kill_all_impl(BattleObjectModuleAccessor* a,u64 p1,bool p2) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64,bool)>(VTABLE(m)[0xf0/8])(m,p1,p2); }
void EffectModule__remove_after_image_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0x138/8])(m,p1); }
void EffectModule__remove_all_after_image_impl(BattleObjectModuleAccessor* a) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*)>(VTABLE(m)[0x140/8])(m); }
void EffectModule__set_pos_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0x150/8])(m,p1); }
void EffectModule__set_rot_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0x158/8])(m,p1); }
void EffectModule__set_scale_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0x160/8])(m,p1); }
...
void EffectModule__set_whole_attr_impl(BattleObjectModuleAccessor* a,bool p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,bool)>(VTABLE(m)[0x1b8/8])(m,p1); }
...
void EffectModule__req_screen_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2,bool p3) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64,u64,bool)>(VTABLE(m)[0x260/8])(m,p1,p2,p3); }
void EffectModule__req_screen_system_impl(BattleObjectModuleAccessor* a,u64 p1,bool p2) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64,bool)>(VTABLE(m)[0x270/8])(m,p1,p2); }
void EffectModule__remove_screen_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0x280/8])(m,p1); }
...
void EffectModule__set_rgb_partial_last_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0x300/8])(m,p1); }
...
void EffectModule__set_rate_last_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0x338/8])(m,p1); }
...
void EffectModule__set_alpha_last_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0x348/8])(m,p1); }
...
void EffectModule__set_slow_rate_mul_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0x378/8])(m,p1); }
void EffectModule__set_slow_rate_no_stop_mul_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0x380/8])(m,p1); }
void EffectModule__set_add_vel_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0x388/8])(m,p1); }
...
void EffectModule__set_disable_render_offset_last_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0x398/8])(m,p1); }
...
void EffectModule__unsync_vis_whole_impl(BattleObjectModuleAccessor* a) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*)>(VTABLE(m)[0x400/8])(m); }
...
void EffectModule__make_offset_hash_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0x420/8])(m,p1); }
void EffectModule__preset_lifetime_rate_partial_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0x428/8])(m,p1); }
void EffectModule__preset_curtail_emitter_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0x430/8])(m,p1); }
...
void EffectModule__set_custom_uv_offset_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,u64)>(VTABLE(m)[0x448/8])(m,p1); }
void EffectModule__remove_post_effect_line_impl(BattleObjectModuleAccessor* a,bool p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,bool)>(VTABLE(m)[0x450/8])(m,p1); }
void EffectModule__request_post_effect_line_circle_impl(BattleObjectModuleAccessor* a,bool p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,bool)>(VTABLE(m)[0x460/8])(m,p1); }
void EffectModule__set_post_effect_line_circle_target_impl(BattleObjectModuleAccessor* a,bool p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,bool)>(VTABLE(m)[0x468/8])(m,p1); }
void EffectModule__request_post_effect_line_parallel_2d_impl(BattleObjectModuleAccessor* a,bool p1) { auto* m=EFFECT_MODULE(a); reinterpret_cast<void(*)(void*,bool)>(VTABLE(m)[0x470/8])(m,p1); }
} // namespace app::lua_bind
