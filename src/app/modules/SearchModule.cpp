...
bool SearchModule__is_inflict_impl(BattleObjectModuleAccessor* a) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0xe0)); return reinterpret_cast<bool(*)(void*)>(VT(m)[0xc8/8])(m); }
void* SearchModule__remove_log_attack_impl(BattleObjectModuleAccessor* a) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0xe0)); return reinterpret_cast<void*(*)(void*)>(VT(m)[0xe0/8])(m); }
...
void* SearchModule__invalid_attack_mask_impl(BattleObjectModuleAccessor* a) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0xe0)); return reinterpret_cast<void*(*)(void*)>(VT(m)[0x100/8])(m); }
void SearchModule__enable_safe_pos_impl(BattleObjectModuleAccessor* a) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0xe0)); reinterpret_cast<void(*)(void*)>(VT(m)[0x128/8])(m); }
void SearchModule__set_offset_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0xe0)); reinterpret_cast<void(*)(void*,u64,u64)>(VT(m)[0x68/8])(m,p1,p2); }
void SearchModule__set_offset2_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0xe0)); reinterpret_cast<void(*)(void*,u64,u64)>(VT(m)[0x70/8])(m,p1,p2); }
...
void SearchModule__set_target_opponent_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2,u64 p3,u64 p4) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0xe0)); reinterpret_cast<void(*)(void*,u64,u64,u64,u64)>(VT(m)[0x98/8])(m,p1,p2,p3,p4); }
void SearchModule__set_pos_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2,u64 p3) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0xe0)); reinterpret_cast<void(*)(void*,u64,u64,u64)>(VT(m)[0xa0/8])(m,p1,p2,p3); }
