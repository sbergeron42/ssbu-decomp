...
void* StopModule__get_other_stop_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=STP(a); return reinterpret_cast<void*(*)(void*,u64)>(VT(m)[0x58/8])(m,p1); }
void* StopModule__cancel_other_stop_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=STP(a); return reinterpret_cast<void*(*)(void*,u64)>(VT(m)[0x60/8])(m,p1); }
...
void StopModule__set_other_stop_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2) { auto* m=STP(a); reinterpret_cast<void(*)(void*,u64,u64)>(VT(m)[0x50/8])(m,p1,p2); }
...
void StopModule__set_link_stop_impl(BattleObjectModuleAccessor* a,bool p1,bool p2) { auto* m=STP(a); reinterpret_cast<void(*)(void*,bool,bool)>(VT(m)[0x80/8])(m,p1,p2); }
...
void StopModule__set_special_stop_impl(BattleObjectModuleAccessor* a,bool p1) { auto* m=STP(a); reinterpret_cast<void(*)(void*,bool)>(VT(m)[0xe0/8])(m,p1); }
} // namespace app::lua_bind
