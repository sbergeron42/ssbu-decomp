...
#define VM(a) (*reinterpret_cast<void**>(reinterpret_cast<u8*>(a) + 0x150))
...
void VisibilityModule__set_int64_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x150)); reinterpret_cast<void(*)(void*,u64,u64)>(VT(m)[0x58/8])(m,p1,p2); }
...
bool VisibilityModule__is_visible_impl(BattleObjectModuleAccessor* a) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x150)); return reinterpret_cast<bool(*)(void*)>(VT(m)[0xd0/8])(m); }
