...
void VisibilityModule__set_int64_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=VM(a); reinterpret_cast<void(*)(void*,u64)>(VT(m)[0x58/8])(m,p1); }
...
bool VisibilityModule__is_visible_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=VM(a); return reinterpret_cast<bool(*)(void*,u64)>(VT(m)[0xD0/8])(m,p1); }
