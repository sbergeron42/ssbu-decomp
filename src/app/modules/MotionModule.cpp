...
void* MotionModule__remove_motion_partial_impl(BattleObjectModuleAccessor* a,u64 p1,bool p2) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x88)); return reinterpret_cast<void*(*)(void*,u64,bool)>(VT(m)[0x328/8])(m,p1,p2); }
