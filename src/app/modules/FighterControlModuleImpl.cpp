...
void FighterControlModuleImpl__delete_command_impl(BattleObjectModuleAccessor* a, s32 group, s32 bit) {
    ...
    u32 bitfield = *reinterpret_cast<u32*>(base + 0x568);
    *reinterpret_cast<u32*>(base + 0x568) = bitfield & ~(1u << bit);
    auto* arr1 = *reinterpret_cast<u8**>(base + 0x578);
    arr1[static_cast<u32>(bit)] = 0;
    auto* arr2 = *reinterpret_cast<u64**>(base + 0x588);
