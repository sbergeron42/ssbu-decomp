...
void MotionAnimcmdModule__change_script_motion_partial_lines_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2,bool p3,bool p4) { auto* m=MA(a); reinterpret_cast<void(*)(void*,u64,u64,bool,bool)>(VT(m)[0x70/8])(m,p1,p2,p3,p4); }
