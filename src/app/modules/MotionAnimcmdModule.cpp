...
void MotionAnimcmdModule__call_script_single_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=MA(a); reinterpret_cast<void(*)(void*,u64)>(VT(m)[0x78/8])(m,p1); }
void MotionAnimcmdModule__change_script_motion_line_single_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=MA(a); reinterpret_cast<void(*)(void*,u64)>(VT(m)[0x80/8])(m,p1); }
