...
#define MA(a) (*reinterpret_cast<void**>(reinterpret_cast<u8*>(a) + 0x188))
...
void* MotionAnimcmdModule__change_script_motion_partial_lines_impl(BattleObjectModuleAccessor* a,u64 p1,bool p2,bool p3) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x188)); return reinterpret_cast<void*(*)(void*,u64,bool,bool)>(VT(m)[0x70/8])(m,p1,p2,p3); }
void* MotionAnimcmdModule__call_script_single_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2,u64 p3) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x188)); return reinterpret_cast<void*(*)(void*,u64,u64,u64)>(VT(m)[0x78/8])(m,p1,p2,p3); }
void* MotionAnimcmdModule__change_script_motion_line_single_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2,u64 p3) { auto* m=reinterpret_cast<void*>(*reinterpret_cast<u64*>(reinterpret_cast<u8*>(a)+0x188)); return reinterpret_cast<void*(*)(void*,u64,u64,u64)>(VT(m)[0x80/8])(m,p1,p2,p3); }
