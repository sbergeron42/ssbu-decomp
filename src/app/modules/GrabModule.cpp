...
bool GrabModule__is_grab_impl(BattleObjectModuleAccessor* a) { auto* m=GM(a); return reinterpret_cast<bool(*)(void*)>(VT(m)[0x78/8])(m); }
f32 GrabModule__pos_x_impl(BattleObjectModuleAccessor* a) { auto* m=GM(a); return reinterpret_cast<f32(*)(void*)>(VT(m)[0x90/8])(m); }
void* GrabModule__center_pos_impl(BattleObjectModuleAccessor* a) { auto* m=GM(a); return reinterpret_cast<void*(*)(void*)>(VT(m)[0x98/8])(m); }
...
void GrabModule__set_power_up_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=GM(a); reinterpret_cast<void(*)(void*,u64)>(VT(m)[0xB0/8])(m,p1); }
void GrabModule__set_scale_2nd_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=GM(a); reinterpret_cast<void(*)(void*,u64)>(VT(m)[0xC0/8])(m,p1); }
