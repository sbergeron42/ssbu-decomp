...
// 710206aee0 -- prev_pos
void* PostureModule__prev_pos_impl(BattleObjectModuleAccessor* a) { auto* m=a->posture_module; void* ret = reinterpret_cast<void*(*)(void*)>(VT(m)[0x90/8])(m); asm(""); return ret; }
...
// 710206af40 -- init_rot
void* PostureModule__init_rot_impl(BattleObjectModuleAccessor* a) { auto* m=a->posture_module; return reinterpret_cast<void*(*)(void*)>(VT(m)[0xc8/8])(m); }
...
void PostureModule__set_rot_impl(BattleObjectModuleAccessor* a,u64 p1,u64 p2) { auto* m=a->posture_module; reinterpret_cast<void(*)(void*,u64,u64)>(VT(m)[0xe0/8])(m,p1,p2); }
...
void* PostureModule__init_scale_impl(BattleObjectModuleAccessor* a) { auto* m=a->posture_module; return reinterpret_cast<void*(*)(void*)>(VT(m)[0x138/8])(m); }
...
void PostureModule__set_owner_scale_impl(BattleObjectModuleAccessor* a) { auto* m=a->posture_module; reinterpret_cast<void(*)(void*)>(VT(m)[0x148/8])(m); }
...
void PostureModule__set_stick_lr_impl(BattleObjectModuleAccessor* a) { auto* m=a->posture_module; reinterpret_cast<void(*)(void*)>(VT(m)[0x178/8])(m); }
...
void* PostureModule__pos_impl(BattleObjectModuleAccessor* a) { auto* m=a->posture_module; void* ret = reinterpret_cast<void*(*)(void*)>(VT(m)[0x60/8])(m); asm(""); return ret; }
...
void* PostureModule__rot_impl(BattleObjectModuleAccessor* a) { auto* m=a->posture_module; void* ret = reinterpret_cast<void*(*)(void*)>(VT(m)[0xd8/8])(m); asm(""); return ret; }
...
void PostureModule__set_scale_status_impl(BattleObjectModuleAccessor* a) { auto* m=a->posture_module; reinterpret_cast<void(*)(void*)>(VT(m)[0x130/8])(m); }
} // namespace app::lua_bind
