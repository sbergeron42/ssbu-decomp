...
void PostureModule__set_rot_impl(BattleObjectModuleAccessor* a,void* p1) { auto* m=a->posture_module; auto* vt=*reinterpret_cast<void***>(m); reinterpret_cast<void(*)(void*,void*)>(vt[0xe0/8])(m,p1); }
...
void PostureModule__init_scale_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=a->posture_module; auto* vt=*reinterpret_cast<void***>(m); reinterpret_cast<void(*)(void*,u64)>(vt[0x138/8])(m,p1); }
...
void PostureModule__set_owner_scale_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=a->posture_module; auto* vt=*reinterpret_cast<void***>(m); reinterpret_cast<void(*)(void*,u64)>(vt[0x148/8])(m,p1); }
...
void PostureModule__set_stick_lr_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=a->posture_module; auto* vt=*reinterpret_cast<void***>(m); reinterpret_cast<void(*)(void*,u64)>(vt[0x178/8])(m,p1); }
