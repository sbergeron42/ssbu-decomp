...
void AbsorberModule__set_size_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=AB(a); reinterpret_cast<void(*)(void*,u64)>(VT(m)[0x90/8])(m,p1); }
void AbsorberModule__set_status_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=AB(a); reinterpret_cast<void(*)(void*,u64)>(VT(m)[0x98/8])(m,p1); }
void AbsorberModule__set_status_all_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=AB(a); reinterpret_cast<void(*)(void*,u64)>(VT(m)[0xa0/8])(m,p1); }
void AbsorberModule__set_turn_impl(BattleObjectModuleAccessor* a,bool p1) { auto* m=AB(a); reinterpret_cast<void(*)(void*,bool)>(VT(m)[0xd0/8])(m,p1); }
void AbsorberModule__set_front_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=AB(a); reinterpret_cast<void(*)(void*,u64)>(VT(m)[0xd8/8])(m,p1); }
void AbsorberModule__set_hop_impl(BattleObjectModuleAccessor* a,bool p1) { auto* m=AB(a); reinterpret_cast<void(*)(void*,bool)>(VT(m)[0xe0/8])(m,p1); }
...
void AbsorberModule__set_hit_stop_mul_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=AB(a); reinterpret_cast<void(*)(void*,u64)>(VT(m)[0x130/8])(m,p1); }
...
void AbsorberModule__set_shield_type_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=AB(a); reinterpret_cast<void(*)(void*,u64)>(VT(m)[0x160/8])(m,p1); }
void AbsorberModule__set_target_property_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=AB(a); reinterpret_cast<void(*)(void*,u64)>(VT(m)[0x1b8/8])(m,p1); }
void AbsorberModule__set_target_category_impl(BattleObjectModuleAccessor* a,u64 p1) { auto* m=AB(a); reinterpret_cast<void(*)(void*,u64)>(VT(m)[0x1c0/8])(m,p1); }
