...
void FighterPikminLinkEventWeaponPikminSetPowerMulStatus__store_l2c_table_impl(FighterPikminLinkEventWeaponPikminSetPowerMulStatus* ev) { reinterpret_cast<void(*)(FighterPikminLinkEventWeaponPikminSetPowerMulStatus*)>(VT(ev)[0x28/8])(ev); }
