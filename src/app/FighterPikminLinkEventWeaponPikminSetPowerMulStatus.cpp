...
LargeRet FighterPikminLinkEventWeaponPikminSetPowerMulStatus__store_l2c_table_impl_71021718e0(FighterPikminLinkEventWeaponPikminSetPowerMulStatus* ev, u64 p1) { return reinterpret_cast<LargeRet(*)(FighterPikminLinkEventWeaponPikminSetPowerMulStatus*, u64)>(VT(ev)[0x30/8])(ev, p1); }
} // namespace app::lua_bind
