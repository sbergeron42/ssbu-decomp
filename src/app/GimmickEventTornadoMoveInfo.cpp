...
void GimmickEventTornadoMoveInfo__store_l2c_table_impl(GimmickEventTornadoMoveInfo* ev) { reinterpret_cast<void(*)(GimmickEventTornadoMoveInfo*)>(VT(ev)[0x28/8])(ev); }
