...
void FighterPikminLinkEventWeaponPikminOnFlag__store_l2c_table_impl(FighterPikminLinkEventWeaponPikminOnFlag* ev) { reinterpret_cast<void(*)(FighterPikminLinkEventWeaponPikminOnFlag*)>(VT(ev)[0x28/8])(ev); }
