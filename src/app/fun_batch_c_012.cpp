// Batch C - 012: MEDIUM FUN_* batch decompilation (0x7102 range)
// Functions: 40 - WorkModule vtable flag patterns
...
u32 FUN_710221e780(s64 param_1)
{
    ...
    s64 lVar2;
    plVar1 = *(s64 **)(*(s64 *)(*(s64 *)(param_1 - 8) + 0x1a0) + 0x68);
    lVar2 = (**(s64 (**)(s64 *, s64))(*plVar1 + 0x60))(plVar1, 1);
    *(u8 *)(lVar2 + 0x30) = 0;
    return 0;
}
...
u32 FUN_7102222240(s64 param_1)
{
    s64 *plVar1;
    plVar1 = *(s64 **)(*(s64 *)(*(s64 *)(param_1 - 8) + 0x1a0) + 0x68);
    plVar1 = (s64 *)(**(s64 (**)(s64 *, s64))(*plVar1 + 0x60))(plVar1, 3);
