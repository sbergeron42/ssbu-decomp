...
LargeRet LinkEventCapturePulled__store_l2c_table_impl_71020b4a00(LinkEventCapturePulled* ev, u64 p1) { return reinterpret_cast<LargeRet(*)(LinkEventCapturePulled*, u64)>(VT(ev)[0x30/8])(ev, p1); }
} // namespace app::lua_bind
