...
// 71020f1b60 (208 bytes): allocate L2CValue table, return as LargeRet
LargeRet Circle__store_l2c_table_impl(Circle* obj) {
    (void)obj;
    return LargeRet{};
}

// 71020f1f20 (2272 bytes): fill existing L2CValue table
