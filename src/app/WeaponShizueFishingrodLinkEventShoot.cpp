...
LargeRet WeaponShizueFishingrodLinkEventShoot__store_l2c_table_impl_71021a3b20(WeaponShizueFishingrodLinkEventShoot* ev, u64 p1) { return reinterpret_cast<LargeRet(*)(WeaponShizueFishingrodLinkEventShoot*, u64)>(VT(ev)[0x30/8])(ev, p1); }
} // namespace app::lua_bind
