...
void AreaContactLog__load_from_l2c_table_impl(AreaContactLog* obj, void* lv_in) {
    ...
    { int t=*e; u32 r; if(t==7||t==2) r=(u32)*(long long*)(e+2); else if(t==3) r=(u32)(long long)(float)e[2]; else r=0; *reinterpret_cast<u32*>(reinterpret_cast<u8*>(obj)+0)=r; }
    ...
    h = 0x10f1076ffbULL;
    e = (*plv==5)?(int*)FUN_7103733d50(*(void**)(plv+2),&h):DAT_710593a3a8;
    { int t=*e; u8 r; if(t==7||t==2) r=(u8)*(long long*)(e+2); else if(t==3) r=(u8)(long long)(float)e[2]; else r=0; reinterpret_cast<u8*>(obj)[0xc]=r; }
    // u8 at +0xd, hash 0xdcbbfb223
    h = 0xdcbbfb223ULL;
    e = (*plv==5)?(int*)FUN_7103733d50(*(void**)(plv+2),&h):DAT_710593a3a8;
    { int t=*e; u8 r; if(t==7||t==2) r=(u8)*(long long*)(e+2); else if(t==3) r=(u8)(long long)(float)e[2]; else r=0; reinterpret_cast<u8*>(obj)[0xd]=r; }
    // u8 at +0xe, hash 0x12731fd2d5
    h = 0x12731fd2d5ULL;
    e = (*plv==5)?(int*)FUN_7103733d50(*(void**)(plv+2),&h):DAT_710593a3a8;
    { int t=*e; u8 r; if(t==7||t==2) r=(u8)*(long long*)(e+2); else if(t==3) r=(u8)(long long)(float)e[2]; else r=0; reinterpret_cast<u8*>(obj)[0xe]=r; }
    // u8 at +0xf, hash 0x11f40cadd0
    h = 0x11f40cadd0ULL;
    e = (*plv==5)?(int*)FUN_7103733d50(*(void**)(plv+2),&h):DAT_710593a3a8;
    { int t=*e; u8 r; if(t==7||t==2) r=(u8)*(long long*)(e+2); else if(t==3) r=(u8)(long long)(float)e[2]; else r=0; reinterpret_cast<u8*>(obj)[0xf]=r; }
...
// 7101fcacc0 (208 bytes): allocate L2CValue table, fill via FUN_7101fcad90, return as LargeRet
LargeRet AreaContactLog__store_l2c_table_impl(AreaContactLog* obj) {
    // Creates new L2CValue table, fills with AreaContactLog fields
    // External: je_aligned_alloc, FUN_7101fcad90 — external branches, won't byte-match
    (void)obj;
    return LargeRet{};
}

// 7101fcb280 (176 bytes): fill existing L2CValue table with AreaContactLog fields
void AreaContactLog__store_l2c_table_impl_7101fcb280(AreaContactLog* obj, void* lv) {
    // Populates L2CValue table via FUN_7101fcad90
    // External branches — won't byte-match
    (void)obj; (void)lv;
}
