...
// 0x710225ac40 â€” call sub.vtable[0x228/8](sub, 0x2f, 0)
...
// 0x710225ac80 â€” call sub.vtable[0x228/8](sub, 0x30, 0)
...
// 0x710225acc0 â€” call sub.vtable[0x228/8](sub, 0x31, 0)
...
// 0x710225b1c0 â€” load StageManager*, call FUN_7102608770(SM)
// Disasm: adrp+ldr(global) â†’ ldr x0,[x8] â†’ bl FUN_7102608770 â†’ return 0
...
// 0x7102250050 â€” link_module (acc+0xd0), vtable[0x3b0/8](mod, 0, 0) â†’ return 0
...
// 0x710226f314 â€” ground_module (acc+0x58), vtable[0x178/8](mod) â†’ return 0
...
// 0x710217b524 â€” work_module (acc+0x50), vtable[0x130/8](mod, param_2, 0x200000e2) â†’ return 0
...
// 0x71020ad4e0 â€” double-deref: *(*(acc+0x10)+0x8), vtable[0xa0/8](mod) â†’ return 0
...
// 0x710216af30 â€” work_module (acc+0x50), vtable[0xb0/8](mod, 0x100000c0), then FUN_71034bcc80(result, 0, 0)
...
// 0x710220c248 â€” load param chain, load ItemManager member, call FUN_71015ba050
// Disasm: ldur x8,[x0,#-8]; str x9,[x0,#0x10]; ldr x8,[x8,#0x1a0]; ldr x8,[x8,#0x190];
//         ldr x1,[x8,#0x220]; adrp+ldr(DAT_71052c3070) â†’ ldr x0,[x8,#0xa8]; bl FUN_71015ba050
